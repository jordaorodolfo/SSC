...
#include "../../SSC-Interface/progressdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_progressDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 15, 11), // "setProgress"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 26), // "on_progressDialog_finished"
QT_MOC_LITERAL(4, 55, 6), // "result"
QT_MOC_LITERAL(5, 62, 11), // "recordValue"
QT_MOC_LITERAL(6, 74, 10) // "saveValues"

    },
    "progressDialog\0setProgress\0\0"
    "on_progressDialog_finished\0result\0"
    "recordValue\0saveValues"
};
...
void progressDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_progressDialog_finished((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->recordValue((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 3: _t->recordValue((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: _t->saveValues(); break;
        default: ;
        }
        ...
        {
            typedef void (progressDialog::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&progressDialog::setProgress)) {
                *result = 0;
            }
        }
    }
...
void *progressDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_progressDialog.stringdata))
...
// SIGNAL 0
void progressDialog::setProgress(int _t1)
{
